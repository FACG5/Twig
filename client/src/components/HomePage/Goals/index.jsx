    ...
    <div className="goals">
      <div>
        ...
        <p className="goals__text">
          ...
          opportunity to communicate about their health in the language that is
          closest to them. We would like to offer medical professionals a high
          quality, free tool to use to enable better communication.
        </p>
      </div>
